...
('Camilo', 'Camilo Tobon', 'Ibague', 'cami@gmail.com', 'admin', '1555555555', true),
('test', 'test testing', 'Av Luro 1233', 'test@test.com', 'test', '1555555554', false),
('juan', 'Juan David', '1 Logan PlKensington, London', 'juanda@qgmail.com', 'eeeooo', '+44 7712345678', false),
...
('https://via.placeholder.com/500', 'Chicago Burguer', 365, 'MedallÃ³n de carne 220g a la parrilla, queso cheddar, tomate, lechuga y pepinos agridulces con ketchup ahumado.'),
('https://via.placeholder.com/500', 'PorteÃ±a Burguer', 370, 'MedallÃ³n de carne 220g a la parrilla, jamÃ³n, queso, huevo a la plancha y salsa de mayo-chÃ­mi.'),
('https://via.placeholder.com/500', 'Veggie Burguer', 350, 'Hamburguesa de garbanzos, guacamole, tomate, lechuga y cebolla morada.'),
('https://via.placeholder.com/500', 'Crispy Burguer', 340, 'MedallÃ³n de carne 220g a la parrilla, queso mozzarella, cebolla crispy, tomates asados, lechuga y salsa ranch.')
;
